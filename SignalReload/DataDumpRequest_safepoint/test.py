...
def Cond_DataDumpRequest():
    os.kill(gdb.selected_inferior().pid, 1)  # Send HUP for reloading configuration
    return True


common.initialize("OnDataDumpRequestForSnapShot", Cond_DataDumpRequest, "ReloadConfigProc", common.return_true, True, True, at_safepoint=True, jcmd_for_safepoint=False)
BreakAtDataDump()
