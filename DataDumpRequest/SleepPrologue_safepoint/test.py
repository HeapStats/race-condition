...
common.initialize("OnDataDumpRequestForDumpThreadRecordData", common.return_true, "JVM_SleepPrologue", common.return_true, True, at_safepoint=True, jcmd_for_safepoint=False)
BreakAtDataDump()
