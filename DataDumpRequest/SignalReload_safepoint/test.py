...
common.initialize("OnDataDumpRequestForSnapShot", Cond_DataDumpRequest, "ReloadConfigProc", common.return_true, True, at_safepoint=True, jcmd_for_safepoint=False)
BreakAtDataDump()
