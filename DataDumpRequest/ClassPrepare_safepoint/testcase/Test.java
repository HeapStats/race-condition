...
public class Test{
  ...
  private static class TestClassLoader implements Runnable{
    public void run(){
      try{
  ...
  private static class GCKicker implements Runnable{
    public void run(){
      while(true){
  ...
  public static void main(String[] args) throws Exception{
    (new Thread(new TestClassLoader())).start();
    Thread gc = new Thread(new GCKicker());
    gc.setDaemon(true);
    gc.start();
