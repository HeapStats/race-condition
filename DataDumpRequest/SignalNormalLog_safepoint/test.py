...
common.initialize("OnDataDumpRequestForSnapShot", Cond_DataDumpRequest, "intervalSigProcForLog", common.return_true, True, at_safepoint=True, jcmd_for_safepoint=False)
BreakAtDataDump()
