...
common.initialize("OnDataDumpRequestForSnapShot", common.return_true, "TGCWatcher::entryPoint:RACE_COND_DEBUG_POINT", common.return_true, False, at_safepoint=True, jcmd_for_safepoint=False)
BreakAtDataDump()
