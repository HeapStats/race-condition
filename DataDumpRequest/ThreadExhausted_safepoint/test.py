...
common.initialize("OnDataDumpRequestForSnapShot", common.return_true, "OnResourceExhausted", common.return_true, True, at_safepoint=True, jcmd_for_safepoint=False)
BreakAtDataDump()
