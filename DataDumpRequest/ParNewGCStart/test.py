...
#common.initialize("OnDataDumpRequestForSnapShot", common.return_true, "OnCMSGCStart", common.return_true, True)
#common.initialize("OnDataDumpRequestForSnapShot", common.return_true, "ParNewGeneration::collect", common.return_true, True)
common.initialize("OnDataDumpRequestForSnapShot", common.return_true, "VM_GenCollectForAllocation::doit", common.return_true, True)
BreakAtDataDump()
